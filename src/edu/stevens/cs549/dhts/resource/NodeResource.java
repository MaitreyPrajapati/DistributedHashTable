...
////////////////////////////////////////////////////////
	...
	@Path("getValue")
	@Produces("application/xml")
	public Response getValue(@QueryParam("key") String key) throws Exception {
	...
	@Path("add")
	@Consumes("application/xml")
	public Response add(TableRep tablerep) throws Exception {
	...
	@Path("delete")
	@Consumes("application/xml")
	public Response delete(@QueryParam("key") String key, @QueryParam("value") String value) throws Exception {
